...
class _RequestsRemoteDataSources implements RequestsRemoteDataSources {
  _RequestsRemoteDataSources(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<UserModel>> geMytRequests() async {
